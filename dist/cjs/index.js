...
const Sidebar = (props) => {
    ...
    return (jsxRuntime.jsx("div", Object.assign({ className: "ct-sidebar", id: "ct-sidebar" }, { children: groups.map(group => {
            const props = {
            ...
            return (jsxRuntime.jsx("div", Object.assign({}, props, { children: group.title }), group.id));
        }) }), void 0));
};
...
const Header = (props) => {
    ...
    let itemRef = require$$0.useRef(null);
    require$$0.useEffect(() => {
        if (itemRef.current) {
            setHeaderItemWidth(itemRef.current.offsetWidth);
        }
    }, [itemRef, setHeaderItemWidth]);
    return (jsxRuntime.jsxs("div", Object.assign({ className: "ct-header", id: "ct-header-root" }, { children: [intervalType === 'month' && headerData.map(header => {
                const year = header.headerDate.getFullYear();
                return (jsxRuntime.jsxs("div", Object.assign({ className: "ct-header__group" }, { children: [jsxRuntime.jsx("div", Object.assign({ className: "ct-header__group__top" }, { children: year }), void 0), jsxRuntime.jsx("div", Object.assign({ className: "ct-header__group__bottom" }, { children: header.items.map(interval => {
                                const month = getMonthLabel(interval.getMonth());
                                return (jsxRuntime.jsx("div", Object.assign({ ref: itemRef, className: "ct-header__group__bottom__item" }, { children: month }), `${year}-${month}`));
                            }) }), void 0)] }), year));
            }), (intervalType === 'day' || intervalType === 'week') && headerData.map(header => {
                const month = getMonthLabel(header.headerDate.getMonth());
                return (jsxRuntime.jsxs("div", Object.assign({ className: "ct-header__group" }, { children: [jsxRuntime.jsx("div", Object.assign({ className: "ct-header__group__top" }, { children: month }), void 0), jsxRuntime.jsx("div", Object.assign({ className: "ct-header__group__bottom" }, { children: header.items.map(interval => {
                                return (jsxRuntime.jsx("div", Object.assign({ ref: itemRef, className: "ct-header__group__bottom__item", "data-testid": `header-item-${month.toLowerCase()}-${interval.getDate()}` }, { children: interval.getDate() }), `${month}-${interval}`));
                            }) }), void 0)] }), month));
            })] }), void 0));
};
...
const createColumns = (columnsSize, headerItemWidth) => {
    ...
    for (let index = 0; index < columnsSize; index++) {
        columns.push(jsxRuntime.jsx("div", { className: "ct-scroll__column", style: { width: `${headerItemWidth}px` }, "data-testid": "scroll-line-column" }, `col-${index}`));
    }
    return columns;
};
const initialState = {
...
class TimelineContent extends require$$0.Component {
    constructor(props) {
        super(props);
        ...
        this.renderMarkers = (markers) => {
            ...
            return markers.map(marker => {
                let style = {
                    ...
                    height: marker.position === exports.MarkerPosition.Full ? groupElementHeight : groupElementHeight / 2,
                };
                if (marker.position === exports.MarkerPosition.Bottom) {
                ...
                return (jsxRuntime.jsx("div", Object.assign({ className: "ct-event", style: style }, { children: marker.title }), marker.id));
            });
        };
        const { groups } = props;
    ...
    render() {
        ...
        return (jsxRuntime.jsx("div", Object.assign({ className: "ct-scroll" }, { children: groups.map((group, idx) => {
                ...
                return (jsxRuntime.jsxs("div", Object.assign({ className: "ct-scroll__line", "data-line-groupid": group.id, style: {
                        minHeight: `${minHeight}px`,
                    }, "data-testid": `scroll-line-${group.id}` }, { children: [createColumns(columnsSize, headerItemWidth), jsxRuntime.jsx("div", Object.assign({ className: "ct-scroll__line__events" }, { children: this.renderMarkers(groupEvents) }), void 0)] }), idx));
            }) }), void 0));
    }
}
...
const populateMarkers = (intervalType, headerData, events, itemWidth) => {
    ...
    Object.keys(events).forEach((v, idx) => {
        ...
        let left = 0;
        let width = 0;
        let position = exports.MarkerPosition.Full;
        ...
        if (nextEvent && nextEvent.groupId === event.groupId) {
            ...
            position = diff < 0 ? exports.MarkerPosition.Top : exports.MarkerPosition.Full;
        }
        let divider = 1;
        ...
        if (maxLeftWidthMarker && left < maxLeftWidthSum) {
            if (maxLeftWidthMarker.position === exports.MarkerPosition.Top) {
                position = exports.MarkerPosition.Bottom;
            }
            else if (maxLeftWidthMarker.position === exports.MarkerPosition.Bottom) {
                position = exports.MarkerPosition.Top;
            }
        }
...
const Timeline = (props) => {
    ...
    const [headerItemWidth, setHeaderItemWidth] = require$$0.useState(60);
    ...
    return (jsxRuntime.jsxs("div", Object.assign({ className: "rt-wrapper" }, { children: [jsxRuntime.jsx(Sidebar, { groups: groups, renderGroupItem: renderGroupItem }, void 0), jsxRuntime.jsx(PerfectScrollbar, { children: jsxRuntime.jsxs("div", Object.assign({ className: "rt-container" }, { children: [jsxRuntime.jsx(Header, { headerData: headerData, setHeaderItemWidth: width => setHeaderItemWidth(width), intervalType: intervalType }, void 0), jsxRuntime.jsx(TimelineContent, { groups: groups, columnsSize: intervalsCounter, headerItemWidth: headerItemWidth, markers: markers, eventRenderer: eventRenderer }, void 0)] }), void 0) }, void 0)] }), void 0));
};
