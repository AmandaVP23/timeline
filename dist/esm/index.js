...
import require$$0, { useRef, useEffect, Component, useState } from 'react';

const Sidebar = (props) => {
    const { groups, groupsClass, renderGroupItem, } = props;
    return (jsx("div", Object.assign({ className: "ct-sidebar", id: "ct-sidebar" }, { children: groups.map(group => {
            const props = {
                className: `ct-sidebar-group-item ${groupsClass || ''}`,
                'data-sidebar-item': group.id,
            };
            if (renderGroupItem)
                return renderGroupItem(props, group);
            return (jsx("div", Object.assign({}, props, { children: group.title }), group.id));
        }) }), void 0));
};
...
const Header = (props) => {
    ...
    return (jsxs("div", Object.assign({ className: "ct-header", id: "ct-header-root" }, { children: [intervalType === 'month' && headerData.map(header => {
                const year = header.headerDate.getFullYear();
                return (jsxs("div", Object.assign({ className: "ct-header__group" }, { children: [jsx("div", Object.assign({ className: "ct-header__group__top" }, { children: year }), void 0), jsx("div", Object.assign({ className: "ct-header__group__bottom" }, { children: header.items.map(interval => {
                                const month = getMonthLabel(interval.getMonth());
                                return (jsx("div", Object.assign({ ref: itemRef, className: "ct-header__group__bottom__item" }, { children: month }), `${year}-${month}`));
                            }) }), void 0)] }), year));
            }), (intervalType === 'day' || intervalType === 'week') && headerData.map(header => {
                const month = getMonthLabel(header.headerDate.getMonth());
                return (jsxs("div", Object.assign({ className: "ct-header__group" }, { children: [jsx("div", Object.assign({ className: "ct-header__group__top" }, { children: month }), void 0), jsx("div", Object.assign({ className: "ct-header__group__bottom" }, { children: header.items.map(interval => {
                                return (jsx("div", Object.assign({ ref: itemRef, className: "ct-header__group__bottom__item", "data-testid": `header-item-${month.toLowerCase()}-${interval.getDate()}` }, { children: interval.getDate() }), `${month}-${interval}`));
                            }) }), void 0)] }), month));
            })] }), void 0));
};
...
(function (MarkerPosition) {
    ...
    MarkerPosition["Bottom"] = "bottom";
    MarkerPosition["Full"] = "full";
})(MarkerPosition || (MarkerPosition = {}));

const createColumns = (columnsSize, headerItemWidth) => {
    const columns = [];
    for (let index = 0; index < columnsSize; index++) {
        columns.push(jsx("div", { className: "ct-scroll__column", style: { width: `${headerItemWidth}px` }, "data-testid": "scroll-line-column" }, `col-${index}`));
    }
    return columns;
};
const initialState = {
...
class TimelineContent extends Component {
        ...
        this.renderMarkers = (markers) => {
            ...
            return markers.map(marker => {
                ...
                if (marker.position === MarkerPosition.Bottom) {
                    style = Object.assign(Object.assign({}, style), { bottom: 0 });
                }
                else {
                    style = Object.assign(Object.assign({}, style), { top: 0 });
                }
                if (eventRenderer)
                    return eventRenderer(marker, style);
                return (jsx("div", Object.assign({ className: "ct-event", style: style }, { children: marker.title }), marker.id));
            });
        };
        const { groups } = props;
    ...
    render() {
        const { markers, groups, headerItemWidth, columnsSize, } = this.props;
        console.log("headerItemWidth", headerItemWidth);
        return (jsx("div", Object.assign({ className: "ct-scroll" }, { children: groups.map((group, idx) => {
                ...
                return (jsxs("div", Object.assign({ className: "ct-scroll__line", "data-line-groupid": group.id, style: {
                        minHeight: `${minHeight}px`,
                    }, "data-testid": `scroll-line-${group.id}` }, { children: [createColumns(columnsSize, headerItemWidth), jsx("div", Object.assign({ className: "ct-scroll__line__events" }, { children: this.renderMarkers(groupEvents) }), void 0)] }), idx));
            }) }), void 0));
    }
}
 ...
 *
 */
const handleDayIntervalType = (startPeriod, endPeriod) => {
    ...
    for (let i = 0; i <= daysDiff; i++) {
        ...
        if (idx < 0) {
            ...
            const newHeaderData = Object.assign(Object.assign({}, headerData[idx]), { items: [...headerData[idx].items, new Date(auxDate)] });
            headerData[idx] = Object.assign({}, newHeaderData);
        }
    }
    return headerData;
};
const handleWeekIntervalType = (startPeriod, endPeriod) => {
    ...
    for (let i = 0; i <= daysDiff; i += 7) {
        ...
        if (idx < 0) {
            ...
            const newHeaderData = Object.assign(Object.assign({}, headerData[idx]), { items: [...headerData[idx].items, new Date(auxDate.valueOf())] });
            headerData[idx] = Object.assign({}, newHeaderData);
        }
    }
    return headerData;
};
const handleMonthIntervalType = (startPeriod, endPeriod) => {
...
const calculateHeaderData = (intervalType, startPeriod, endPeriod) => {
 ...
 *
 */
const populateMarkers = (intervalType, headerData, events, itemWidth) => {
    if (headerData.length === 0)
        return [];
    const newEvents = [...events];
    const markers = [];
    let maxLeftWidthMarker;
    ...
    Object.keys(events).forEach((v, idx) => {
        ...
        const marker = Object.assign(Object.assign({}, newEvents[idx]), { left,
            width,
            position });
...
const Timeline = (props) => {
    const { groups, renderGroupItem, intervalType, startPeriod, events, eventRenderer, endPeriod, } = props;
    ...
    return (jsxs("div", Object.assign({ className: "rt-wrapper" }, { children: [jsx(Sidebar, { groups: groups, renderGroupItem: renderGroupItem }, void 0), jsx(PerfectScrollbar, { children: jsxs("div", Object.assign({ className: "rt-container" }, { children: [jsx(Header, { headerData: headerData, setHeaderItemWidth: width => setHeaderItemWidth(width), intervalType: intervalType }, void 0), jsx(TimelineContent, { groups: groups, columnsSize: intervalsCounter, headerItemWidth: headerItemWidth, markers: markers, eventRenderer: eventRenderer }, void 0)] }), void 0) }, void 0)] }), void 0));
};

export { MarkerPosition, Timeline };
